...
describe('total likes of a given list of blogs', () => {
  ...
  test('bigger list of blogs', () => {
    ...
    expect(listHelper.totalLikes(blogs)).toBe(blogs.reduce((sum, blog) => sum + blog.likes, 0));
  });
});
...
describe('finding the most blogs by single author', () => {
  ...
  test('one item in list of blogs', () => {
    ...
    expect(listHelper.mostBlogs(blogs)).toEqual({ author: blogs[0].author, blogs: 1 });
  });
  test('bigger list of blogs', () => {
    const blogs = [{
      _id: '5a422a851b54a676234d17f7',
    ...
    expect(listHelper.mostBlogs(blogs)).toEqual({ author: blogs[3].author, blogs: 3 });
  });
});
...
describe('finding the single author with most likes', () => {
  ...
  test('one item in list of blogs', () => {
    ...
    expect(listHelper.mostLikes(blogs)).toEqual({ author: blogs[0].author, likes: blogs[0].likes });
  });
  test('bigger list of blogs', () => {
    const blogs = [{
      _id: '5a422a851b54a676234d17f7',
    ...
    expect(listHelper.mostLikes(blogs)).toEqual({ author: blogs[1].author, likes: 17 });
  });
});
